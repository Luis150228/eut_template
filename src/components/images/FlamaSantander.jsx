// FlamaSantander.jsx
export default function FlamaSantander({ size = 220, color, className = '', ...props }) {
	const themeColorClasses = 'fill-current text-[#e30613] dark:text-white'; // light=rojo, dark=blanco

	return (
		<svg
			viewBox='0 0 514.91 461.72'
			width={size}
			className={`${!color ? themeColorClasses : ''} ${className}`}
